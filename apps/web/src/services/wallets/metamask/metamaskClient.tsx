...
class MetaMaskWallet implements WalletInterface {
  ...
  async signMessage(_message: Uint8Array): Promise<{ signature: string }> {
    throw new Error("signMessage is not implemented for MetaMaskWallet yet");
  }

  async sendTransaction(_transaction: any): Promise<string | null> {
    throw new Error("sendTransaction is not implemented for MetaMaskWallet yet");
  }
}
