...
export interface MirrorNodeAccountTokenBalanceWithInfo
  extends MirrorNodeAccountTokenBalance {
...
export class MirrorNodeClient {
  ...
  async getAccountTokenBalances(accountId: AccountId) {
    ...
    ] as MirrorNodeAccountTokenBalance[];
  ...
  async getAccountTokenBalancesWithTokenInfo(
    accountId: AccountId
